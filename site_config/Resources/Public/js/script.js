...
$document.ready(function () {
  ...
  if (plugins.rdMailForm.length) {
    var i, j, k,
        msg = {
          'MF000': 'Formular erfolgreich gesendet!',
        ...
        beforeSubmit: function () {
          ...
          if (isValidated(inputs)) {
            ...
            if (output.hasClass("snackbars")) {
              output.html('<p><span class="icon text-middle fa fa-circle-o-notch fa-spin icon-xxs"></span><span>Senden...</span></p>');
...
$(document).ready(function() {
  $(".col-lg-service").parent("div").addClass("cell-lg-10");
});
