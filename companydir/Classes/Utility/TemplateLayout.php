...
namespace GRCR\Companydir\Utility;
...
class TemplateLayout implements SingletonInterface
{
    ...
    public function getAvailableTemplateLayouts($pageUid)
    {
        ...
        if (isset($GLOBALS['TYPO3_CONF_VARS']['EXT']['companydir']['templateLayouts'])
            && is_array($GLOBALS['TYPO3_CONF_VARS']['EXT']['companydir']['templateLayouts'])
        ) {
            $templateLayouts = $GLOBALS['TYPO3_CONF_VARS']['EXT']['companydir']['templateLayouts'];
        }
    ...
    protected function getTemplateLayoutsFromTsConfig($pageUid)
    {
        ...
        if (isset($pagesTsConfig['tx_companydir_companydir.']['templateLayouts.']) && is_array($pagesTsConfig['tx_companydir_companydir.']['templateLayouts.'])) {
            $templateLayouts = $pagesTsConfig['tx_companydir_companydir.']['templateLayouts.'];
        }
        return $templateLayouts;
    }
}
