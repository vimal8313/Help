...
{
    /**
     * @var \GRCR\Companydir\Controller\CategoryController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\GRCR\Companydir\Controller\CategoryController::class)
    ...
    public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView()
    {
        ...
        $categoryRepository = $this->getMockBuilder(\GRCR\Companydir\Domain\Repository\CategoryRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $category = new \GRCR\Companydir\Domain\Model\Category();
