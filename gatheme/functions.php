...
<script type="text/javascript">
    ...
    <?php if (isset($userName)) : ?>
        ...
        ga('set', 'dimension1', <?php echo(json_encode($userName)); ?>); // Set the user ID using signed-in user_id.
    <?php endif; ?>
    ga('send', 'pageview');
</script>
...
add_filter( 'fu_menu_options', 'function_name_custom' );


function function_name_custom(){
 update_option('fu_mail_email_not_exist','hello11');
}
