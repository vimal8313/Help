                    ...
                    <?php the_title( '<h1 class="entry-title">', '</h1>' ); ?>
                      ...
                      <?php
                        ...
                        <form id="pmpro_form" class="pmpro_form" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
                          ...
                          <?php if($pmpro_review) { ?>
                            <p><?php _e('<div class="checkout-almost"><b>Almost done!</b></div></br> Review the subscription information and pricing below then <strong>click the "Complete Payment" button</strong> to finish your order.', 'paid-memberships-pro' );?></p>
                          <?php } ?>
                          <div id="pmpro_pricing_fields" class="pmpro_checkout">
                            <h3>
                              <span class="pmpro_checkout-h3-name"><?php _e('Subscription Level', 'paid-memberships-pro' );?></span>
                             <span class="pmpro_checkout-h3-msg"><a href="<?php echo pmpro_url("levels"); ?>"><?php _e('change', 'paid-memberships-pro' );?></a></span>

                            </h3>
                            <div class="pmpro_checkout-fields">
                              <p>
                              <?php
                              $a = str_replace("+ access to",':</br>',$pmpro_level->name);
                              ?>
                                <?php printf(__('You have selected the <strong>%s</strong> subscription level.', 'paid-memberships-pro' ), $a);?>
                              </p>
                              ...
                              <div id="pmpro_level_cost">
                                ...
                                <?php } ?>
                                <?php
                                echo str_replace("membership","subscription",str_replace(" now",'',wpautop(pmpro_getLevelCost($pmpro_level)))); ?>
                                <?php echo str_replace("Membership expires after 1","Subscription auto renews each",wpautop(pmpro_getLevelExpiration($pmpro_level))); ?>
                              </div>
                          ...
                          <div id="pmpro_user_fields" class="pmpro_checkout">
                            <h3>
                              ...
                              <span class="pmpro_checkout-h3-msg"><?php _e('Already have an account?', 'paid-memberships-pro' );?> 
                              <!-- <a href="<?php //echo wp_login_url(pmpro_url("checkout", "?level=" . $pmpro_level->id)); ?>"> -->
                              <a href="<?php echo get_home_url(); ?>">
                              <?php _e('Log in here', 'paid-memberships-pro' );?></a></span>
                            </h3>
                            <div class="pmpro_checkout-fields">
                          ...
                          <?php } elseif($current_user->ID && !$pmpro_review) { ?>
                            <div id="pmpro_account_loggedin" class="pmpro_message pmpro_alert">
                              <?php printf(__('You are logged in as <strong>%s</strong>. If you would like to use a different account for this subscription, <a href="%s">log out now</a>.', 'paid-memberships-pro' ), $current_user->user_login, wp_logout_url($_SERVER['REQUEST_URI'])); ?>
                          ...
                          <div class="pmpro_submit">
                            ...
                            <?php if($pmpro_review) { ?>
                              ...
                              <span id="pmpro_submit_span">
                                ...
                                <input type="submit" class="pmpro_btn pmpro_btn-submit-checkout btn btn-default" value="<?php _e('Complete Payment', 'paid-memberships-pro' );?> &raquo;" />
                              </span>
                            ...
                            <?php } else { ?>
                              ...
                              <?php
                                ...
                                <span id="pmpro_submit_span">
                                  ...
                                  <input type="submit" class="pmpro_btn pmpro_btn-submit-checkout btn btn-default" value="<?php if($pmpro_requirebilling) { _e('Submit and Check Out', 'paid-memberships-pro' ); } else { _e('Submit and Confirm', 'paid-memberships-pro' );}?> &raquo;" />
                                </span>
                                <?php
                                }
                              ?>
