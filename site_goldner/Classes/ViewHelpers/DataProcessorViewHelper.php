 ...
 */
class DataProcessorViewHelper extends AbstractViewHelper implements CompilableInterface {
	...
	public static function renderStatic(array $arguments,\Closure $renderChildrenClosure,RenderingContextInterface $renderingContext) {
		...
		if ($arguments['uid'] !== null && $arguments['table'] !== null) {
			...
			$whereClause = '1 AND `' . $arguments['foreignField'] . '` = \'' . $arguments['uid'] . '\' ' . $arguments['additionalWhere'];
			$groupBy = '';
			$limit = '';
