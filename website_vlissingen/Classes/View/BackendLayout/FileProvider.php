<?php
namespace WIND\WebsiteVlissingen\View\BackendLayout;
...
class FileProvider implements DataProviderInterface {
	...
	public function addBackendLayouts(DataProviderContext $dataProviderContext, BackendLayoutCollection $backendLayoutCollection) {
		...
		if (is_array($pageTsConfig) && (int)$pageTsConfig['website_vlissingen.']['enabled'] === 1) {
	...
	protected function getLayoutFiles() {
		...
		$path = ExtensionManagementUtility::extPath('website_vlissingen') . self::LAYOUT_PATH;
