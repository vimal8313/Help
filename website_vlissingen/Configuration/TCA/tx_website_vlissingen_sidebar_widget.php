	...
	'columns' => array(
		'tt_content' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tt_content.pid=###CURRENT_PID### AND tt_content.CType="fce_sidebarwidget"',
				'maxitems' => 1,
			),
		),
		'hidden' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_website_vlissingen_sidebar_widget.uid=###REC_FIELD_l10n_parent### AND tx_website_vlissingen_sidebar_widget.sys_language_uid IN (-1,0)',
			)
		),
		...
		'link_text' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:website_vlissingen/Resources/Private/Language/Backend.xlf:sidebarwidget.link_text',
			'config' => array(
				'type' => 'input',
				'size' => 50,
				'eval' => 'trim'
