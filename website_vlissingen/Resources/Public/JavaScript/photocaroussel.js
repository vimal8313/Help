...
function initCycleCarousel() {
	jQuery('div.gallery-box').scrollAbsoluteGallery({
		mask: 'div.mask',
		slider: 'div.slideset',
		slides: 'div.slide',
		btnPrev: 'a.btn-prev',
...
;(function($){
	...
	ScrollAbsoluteGallery.prototype = {
		...
		attachEvents: function() {
			...
			$('div.main-holder div.gallery-box div.pause ul li a ').click(function() {
				if (pauze) {
					self.autoRotate();
					pauze = false;
					$('div.main-holder div.gallery-box div.pause').removeClass('break');
				} else {
					pauze = true;
					clearTimeout(self.timer);
					$('div.main-holder div.gallery-box div.pause').addClass('break');
				}
